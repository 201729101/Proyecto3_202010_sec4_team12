 ...
 */
public class ListaEncadenada< E extends Comparable<E>> implements Comparable,Iterable,Cloneable
{
	/**
...
//		numElem++;
	...
	{
		Nodo actual = primero;
		Nodo siguiente = primero.darSiguiente();
		primero = siguiente;
		actual.cambiarSiguiente(null);
		numElem--;
		return (E) actual.darElemento();
	}
	...
	public ListaEncadenada concatenar(ListaEncadenada finale)
	{
		agregarFinal(finale.darPrimero());
//		ultimo.cambiarSiguiente(finale.darPrimero());
		ultimo=finale.darUltimo();
		numElem+=finale.darTamano();
		return this;
	}
}